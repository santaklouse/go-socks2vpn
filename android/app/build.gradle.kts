...
val releaseVersionName = providers.gradleProperty("releaseVersionName").orElse("1.0.4-dev")
val releaseVersionCode = providers.gradleProperty("releaseVersionCode").map(String::toInt).orElse(12)
